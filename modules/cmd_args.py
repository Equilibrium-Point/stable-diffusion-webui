...
parser.add_argument("--only-prepare", action='store_true', help="don't start the webui, only install the necessary components to run it before exiting")
parser.add_argument("--only-prepare-init", action='store_true', help="don't start the webui, only install the necessary components to run it and perform an initial startup before exiting")
